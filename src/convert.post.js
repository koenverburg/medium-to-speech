// copied for from https://github.com/ericclemmons/medium-to-markdown/blob/master/routes/api/post/%3Auser/%3Apost/index.get.js
...
(async function  () {
  ...
  try {
    // https://medium.com/better-programming/everyday-activities-to-become-a-better-developer-3d00ec8d14a5
    await convertPost('better-programming', 'everyday-activities-to-become-a-better-developer-3d00ec8d14a5');
  } catch (error) {
